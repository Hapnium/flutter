...
void main() {
  ...
  test('list albums', () async {
    ...
    bool newest = true;
    var result = await Gallery.listAlbums(mediumType: mediumType);
  ...
  test('list media', () async {
    ...
    int skip = 0;
    int take = 1;
    List<Album> albums = await Gallery.listAlbums(mediumType: mediumType);
  ...
  test('get medium', () async {
    ...
    MediumType mediumType = MediumType.image;
    Medium result = await Gallery.getMedium(
      mediumId: mediumId,
      mediumType: mediumType,
    );
  ...
  test('get thumbnail', () async {
    String mediumId = 0.toString();
    MediumType mediumType = MediumType.image;
    List result = await Gallery.getThumbnail(mediumId: mediumId, mediumType: mediumType);
  ...
  test('get album thumbnail', () async {
    ...
    List result = await Gallery.getAlbumThumbnail(albumId: albumId);
  ...
  test('get file', () async {
    String mediumId = 0.toString();
    MediumType mediumType = MediumType.image;
    File result = await Gallery.getFile(mediumId: mediumId, mediumType: mediumType);
