...
class WebSocketException implements Exception {
  ...
  /// Creates a [WebSocketException] with a specified [message] and optional fields
  ...
  /// Example:
  /// ```dart
  /// WebSocketException("An error occurred", code: 500).toString();
  /// // Output: "Main Exception: An error occurred. Code: 500"
  /// ```
  @override
  String toString() {
    if (code != null) {
      return "Web Socket Exception: $message. Code: $code";
    }

    return "Web Socket Exception: $message";
  }
}