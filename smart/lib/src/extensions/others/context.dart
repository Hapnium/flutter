...
extension ContextExtension on BuildContext {
  ...
  /// Returns the current screen size based on the provided [ResponsiveConfig].
  ///
  /// If no breakpoints are defined in the config, it defaults to common breakpoints:
  /// - Mobile: under 600px
  /// - Tablet: between 600px and 1200px
  /// - Desktop: 1200px and above
  ScreenSize screenSize({ResponsiveConfig? config}) {
    final ResponsiveConfig responsive = config ?? ResponsiveConfig(mobile: 600, tablet: 1200);
