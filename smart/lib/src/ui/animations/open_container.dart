...
class _OpenContainerState<T> extends State<OpenContainer<T?>> {
  ...
  Future<void> openContainer() async {
    ...
    final T? data = await Navigator.of(context, rootNavigator: widget.useRootNavigator).push(_OpenContainerRoute<T>(
...
class _OpenContainerRoute<T> extends ModalRoute<T> {
  ...
  void _takeMeasurements({required BuildContext navigatorContext, bool delayForSourceRoute = false}) {
    final RenderBox navigator = Navigator.of(navigatorContext, rootNavigator: useRootNavigator).context.findRenderObject()! as RenderBox;
