...
/// 
/// It extends [BodyByteStream] to provide a stream of bytes which is the response body.
abstract interface class HttpClientResponse implements BodyByteStream {
