...
class NotifyException implements Exception {
  ...
  /// Creates a [NotifyException] with a specified [message] and optional fields
  /// for [code]
  ///
  /// Example usage:
  /// ```dart
  ...
  /// Example:
  /// ```dart
  /// NotifyException("An error occurred", code: 500).toString();
  /// // Output: "Main Exception: An error occurred. Code: 500"
  /// ```
  @override
  String toString() {
    if (code != null) {
      return "Notify Exception: $message. Code: $code";
    }

    return "Notify Exception: $message";
  }
}