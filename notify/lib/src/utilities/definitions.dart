...
typedef InAppNotificationBuilder = Widget Function(String text, InAppState state);
...
typedef InAppNotificationIconBuilder = Widget Function(InAppState state);
...
typedef InAppNotificationConfigurer = InAppConfig Function(InAppConfig config);
